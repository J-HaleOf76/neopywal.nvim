...
neopywal.normal = {
	...
	b = { bg = U.blend(colors.color8, colors.background, 0.4), fg = colors.foreground, gui = "bold" },
	y = { bg = U.blend(colors.color8, colors.background, 0.4), fg = colors.foreground, gui = "bold" },

	c = { bg = U.blend(colors.color8, colors.background, 0.2), fg = colors.foreground, gui = "bold" },
	x = { bg = U.blend(colors.color8, colors.background, 0.2), fg = colors.foreground, gui = "bold" },
}
